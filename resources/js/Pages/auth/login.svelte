                ...
                <form class="space-y-4 md:space-y-6" on:submit|preventDefault={submitForm}>
                    ...
                    <div>
                     ...
                     <div class="flex items-center justify-end">
                         <a href="/forgot-password" use:inertia class="text-sm font-medium text-emerald-600 hover:underline dark:text-emerald-400">Lupa Password?</a>
                     </div>
                     ...
                     <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                         Belum punya akun?   <a href="/register" use:inertia class="font-medium text-emerald-600 hover:underline dark:text-emerald-400">Buat disini</a>
                    </p>
